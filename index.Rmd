...
shiny::dateInput("dateInputVal", label = "Provide a water right date")
...
output$selectedWDIDinput <- DT::renderDT({
  ...
  DT::datatable(
    ...
    dplyr::filter(
      dplyr::select(sf::st_drop_geometry(sub_pts()), wdid, structure_name, structure_type,
                    gnis_id, water_district, adjudication_date,prior_adjudication_date , adjudication_date, admin_number
                    ),
      wdid == input$selectWDID
    ), 
     style = "bootstrap",
...
# dplyr::filter(
#   dplyr::select(sf::st_drop_geometry(sub_pts()), wdid, structure_name, structure_type, gnis_id, water_district, adjudication_date,prior_adjudication_date , adjudication_date, admin_number
#                 ),
#   wdid == input$selectWDID
# ) 
```
...
<!-- ### tht -->
<!-- ```{r} -->
<!-- shiny::verbatimTextOutput("dateInputVal") -->
<!-- ``` -->

<!-- ```{r context="server"} -->

<!-- # render district value box at start -->
<!-- output$dateInputVal <- shiny::renderPrint({ -->
<!--   print(date_input()) -->
<!-- }) -->
<!-- ``` -->
<!-- # --- -->
