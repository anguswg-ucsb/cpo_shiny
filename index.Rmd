...
Depending on the amount of water in the river, the average year of the senior water rights-holder placing the call on the river changes. Select the hydrologic year type (Dry, Average, or Wet) below to highlight the corresponding line on the graph. 
...
The top performing predictor variable was selected for each district, thus when you select a district from the above menu, you will be prompted to enter a value for one of the following 3 predictor variables: 
- May 1st SWE
...
Provide one of these variables in the text box below and press the "Predict" button to generate a predicted average summer call year value. The model parameters and perforamnce can be seen in the table on the right hand side of the page.
        ...
        if (!is.null(input$newDataInput)) {
          ...
          ##########################################
            ...
            model_table <- 
              ...
              gt::tab_style(
                style = gt::cell_fill(color = "#3EB489", alpha = 0.7), # highlight prediction value
